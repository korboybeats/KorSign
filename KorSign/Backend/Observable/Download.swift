...
class Download: Identifiable, @unchecked Sendable {
	...
	let stagingDirectory = FileManager.default.downloadStaging.appendingPathComponent(UUID().uuidString, isDirectory: true)
	var resumeData: Data?
	...
	/// The directory belongs to this Download instance, never to a server filename or app ID.
