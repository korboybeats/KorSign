...
struct SettingsView: View {
    ...
    private var selectedCertificate: CertificatePair? {
        _certificates.first { $0.uuid == _storedSelectedCert }
    }

    private let _donationsUrl = "http://buymeacoffee.com/korboy"
    private let _githubUrl = "https://github.com/korboybeats/KorSign"
